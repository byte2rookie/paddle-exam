...
def ask():
    ...
    message_content = " 以下是一篇高中作文，自命题作文 " \
        ...
        "- 完成五个任务，1.打分（满分为60），2.生成评语，评语既要肯定好的地方也要指出不足，3.润色一些语句（给出原句和润色后，并用换行隔开），4.推荐作文想提高可以参照的知识点，5.根据这些知识点推荐网课 " \
    ...
    try:
        ...
        if json_start != -1 and json_end != -1:
            ...
            # 使用json.dumps进行漂亮的打印
            print(json.dumps(answer_dict, indent=2, ensure_ascii=False).replace("\\n", "\n"))
        else:
            answer_dict = {}
            print("未找到合法的JSON内容。")
